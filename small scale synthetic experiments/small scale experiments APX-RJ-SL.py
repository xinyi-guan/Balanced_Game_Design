...
with open('small-scale-summary-results-10-instances_APX-RJ-SL.csv', mode='w', newline='') as file:
    ...
    for current_seed in np.flip(seed_vec):
        ...
        output_filename = f'small-scale_instance_randomseed_{current_seed}_N=11_K=12_APX-RJ-SL.txt'
        ...
        df.to_csv(f'small-scale-best_incumbent_game_design_randomseed_{current_seed}_N=11_K=12_APX-RJ-SL.csv', index=False, header=False)
