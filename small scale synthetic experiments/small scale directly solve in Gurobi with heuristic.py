...
with open('small-scale-summary-results-10-instances_directly_solve_in_Gurobi-with-heuristic.csv', mode='w', newline='') as file:
    ...
    for current_seed in seed_vec:
        ...
        df.to_csv(f'small-scale-best_incumbent_game_design_randomseed_{current_seed}_directly_solve_in_Gurobi-with-heuristic.csv', index=False, header=False)
